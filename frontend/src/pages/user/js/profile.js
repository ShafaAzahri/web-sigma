...
function initializeEditProfile() {
    ...
    passwordForm.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch('/backend/controllers/change_password.php', {
                method: 'POST',
                headers: {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const response = await fetch('/backend/controllers/profile.php', {
                method: 'POST',
                body: formData
            });
            const data = await response.json();
...
async function loadCurrentProfileData() {
    try {
        const [profileRes, prodiRes] = await Promise.all([
            fetch('/backend/controllers/get_mahasiswa.php'),
            fetch('/backend/controllers/get_program_studi.php')
        ]);
