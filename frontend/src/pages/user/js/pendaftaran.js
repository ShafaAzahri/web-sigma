...
document.addEventListener('DOMContentLoaded', async function() {
    try {
        ...
        const authResponse = await fetch('/backend/controllers/auth.php');
        ...
        const periodResponse = await fetch(`/backend/controllers/cek-periode-pendaftaran.php?id_ukm=${id_ukm}`);
        const periodData = await periodResponse.json();

        // Check registration status
        const statusResponse = await fetch(`/backend/controllers/cek-status-pendaftaran.php?id_ukm=${id_ukm}`);
